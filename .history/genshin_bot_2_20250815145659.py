...
# --- IMPORTANTE: Reemplaza las URLs con los enlaces directos a las imágenes ---
# He corregido las primeras para que sirvan de ejemplo.
# Debes obtener el enlace directo para las demás.
IMAGENES = {
...
def main() -> None:
    """Inicia el bot."""
    print("Iniciando bot...")
    # Reemplaza "TU_TOKEN_DE_TELEGRAM" con el token de tu bot
    application = Application.builder().token("8038008029:AAEG4JrZumIHahwa3q1GX5ddXrcGzrdH-TY").build()
